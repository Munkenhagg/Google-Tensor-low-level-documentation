...
- **None** - ? - probably expecting more data, looking into it right now
...
- **02 00 00 00**: none - i think it is asking for more data like total size and bl2.img. working on finding out. /dev/ttyACM0 also disappears until releasing the power button
- **03 00 00 00**: 0x15

...
you should see first `bl1_header_fail` and then it starts to slowly fill up with `irom_booting_failure` or similar. that confirms 100% that the bootROM parsed the image you sent it
